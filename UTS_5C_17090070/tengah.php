...
if ($_GET[module]=='home'){
  echo "
        ...
        <div class='center_prod_box_big'>
            <div class='product_title_big'>PO Tegal Bahari</div>
              <div><p>Selamat datang di website kami, sebagai sarana Informasi secara online guna kemudahan dalam mendapatkan info layanan dan informasi lainnya bagi pelanggan kami. Tegal Bahari hadir sejak tahun 1974 guna memenuhi akan kebutuhan transportasi yang nyaman, aman dan terpercaya.</p>
<p>
...
<p>
<img src=images/tegalbahari.jpg title='Armada Bus Tegal Bahari' width=520 height=350 />
</p>
</div>
          </div> 
...
elseif ($_GET[module]=='profilkami'){
  ...
  echo "<div class='center_title_bar'>Profil</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Profil PO Tegal Bahari</div>
...
elseif ($_GET[module]=='carapesan'){
  ...
  echo "<div class='center_title_bar'>Cara Pemesanan</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Prosedur Pemesanan Tiket di PO Tegal Bahari</div>
              <div>$r[static_content]</div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
$pesan="Terimakasih telah melakukan pemesanan tiket online di PO Tegal Bahari <br /><br />  
        Nama: $nama <br />
        Alamat: $alamat <br/>
        Telpon: $telpon <br /><hr />
...
$pesan.="<br /><br />Total : Rp. $total_rp  
         ...
         <br /><br />Silahkan lakukan pembayaran sebanyak Grand Total yang tercantum, rekeningnya: PO Tegal Bahari
         <br />Apabila sudah transfer, konfirmasi ke nomor: PO Tegal Bahari";
...
mail("tegalbahari",$subjek,$pesan,$dari);
...
$pesan.="<br /><br />Total : Rp. $total_rp 
         ...
         <br />Apabila sudah transfer, konfirmasi ke pihak PO Tegal Bahari atau mendatangi kantor PO Tegal Bahari";

$subjek="Pemesanan Tiket Online";

$dari = "From: Tegal Bahari\r\n";
$dari .= "Content-type: text/html\r\n";
